...
export function Dashboard({ mode: initialMode, onBackToSelection }: DashboardProps) {
  ...
  // Admin functions moved to AdminPage component
...
// CreateUserWidget moved to /components/admin/CreateUserWidget.tsx
