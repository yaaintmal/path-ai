...
const features = [
  {
    ...
    title: 'KI-Lernpfade',
    description:
      'Generiere dynamische Lernpfade zu jedem Thema. Die KI erstellt strukturierte Unterthemen, die du Schritt für Schritt meistern kannst.',
  ...
  },
  {
    ...
    description:
      'Starte direkt mit kuratierten Pfaden für Rollen wie "Frontend Developer" oder "Data Scientist". Spare Zeit bei der Planung.',
  ...
  },
  {
    ...
    description:
      'Verfolge deine Lernzeit, abgeschlossene Themen und deine Daily Streak. Visualisiere deinen Erfolg mit detaillierten Charts.',
  ...
  },
  {
    ...
    description:
      'Sammle Punkte durch Lernen und löse sie gegen exklusive Themes, Badges und Profil-Upgrades ein.',
  ...
  },
  {
    ...
    description:
      'Behalte den Überblick über offene und abgeschlossene Themen. Speichere wichtige Inhalte als Lesezeichen für später.',
  ...
  },
  {
    ...
    title: 'Fokus-Modus',
    description:
      'Lerne konzentriert mit integriertem Pomodoro-Timer und ablenkungsfreiem Interface für maximale Produktivität.',
      ...
      <div className="relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 animate-fade-in-delayed">
            Entdecke eine völlig neue Art zu lernen - individuell, flexibel und immer an deiner
            Seite.
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              >
                ...
                >
                  <div
                    className={`w-full h-full rounded-2xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center`}
                  >
